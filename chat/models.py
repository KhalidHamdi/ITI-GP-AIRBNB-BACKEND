...
class ConversationMessage(models.Model):
    ...
    sent_to = models.ForeignKey(User, related_name='messages_sent', on_delete=models.CASCADE, db_index=True)
    created_by = models.ForeignKey(User, related_name='messages_received',null=True, on_delete=models.CASCADE, db_index=True)
